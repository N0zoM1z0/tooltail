...
5. Implement and verify the remaining granular retention/deletion/diagnostic-export controls, or accept a documented scope change through an ADR without weakening safety invariants. Capsule merge remains deliberately unsupported under ADR 0009 and is not required for the pristine-state continuity proof.
